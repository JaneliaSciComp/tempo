        ...
        function updateAxes(obj, timeRange)
            ...
            if obj.controller.selectedTime(1) == obj.controller.selectedTime(2)
                ...
                if obj.controller.currentTime > timeRange(1) && obj.controller.currentTime < timeRange(2)
                    ...
                    text(obj.controller.currentTime, textY, secondstr(obj.controller.currentTime, obj.controller.timeLabelFormat), ...
                ...
                if startInRange
                    ...
                    text(obj.controller.selectedTime(1), textY, secondstr(obj.controller.selectedTime(1), obj.controller.timeLabelFormat), ...
                        'VerticalAlignment', 'baseline', 'HorizontalAlignment', 'center', ...
                        'FontName', textFont, 'Color', redColor);
                end
                if endInRange
                    line([obj.controller.selectedTime(2) obj.controller.selectedTime(2)], [0.8 1], 'Color', 'red');
                    text(obj.controller.selectedTime(2), textY, secondstr(obj.controller.selectedTime(2), obj.controller.timeLabelFormat), ...
                        'VerticalAlignment', 'baseline', 'HorizontalAlignment', 'center', ...
                        'FontName', textFont, 'Color', redColor);
                end
